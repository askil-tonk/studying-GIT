...
# numbers_filtered = filter(fltr, numbers)
# numbers_proc = map(cube, numbers_filtered)
# print(filter(fltr, numbers))

print(*map(cube, filter(fltr, numbers)), sep='\n')
